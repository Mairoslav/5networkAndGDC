...
extension TMDBResponse: LocalizedError {
    var errorDescription: String? {
        ...
        return "Seems like Email or Password are wrong" // the same allert mesage appears, just changed the text under the bolt text, that one is defined in "LoginViewController.swift" under "showLoginFailure" method together with "OuKey".
    }
}
