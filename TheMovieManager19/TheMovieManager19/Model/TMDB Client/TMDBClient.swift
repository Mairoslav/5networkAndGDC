...
class TMDBClient {
    ...
    static let apiKey = "841622fb8a5a4f75f298f96cb8ba7cd9" // commented out* (Question2: however when commented out, user cannot log in via website.
    // static let apiKey = ""
        ...
        let task = URLSession.shared.dataTask(with: request) { (data, response, error) in
            ...
            do {
                ...
                do {
                    ...
                    DispatchQueue.main.async {
                        /// 00:37 Finally, just in case the parsing does fail, we handle the error case here in the catch block.
                        /// 00:42 Then in the "LoginViewController.swift", ... move there ...
                        completion(nil, error)
                    }
                }
                /// end here
