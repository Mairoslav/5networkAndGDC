...
struct TMDBResponse: Codable {
    ...
    let statusCode: Int
    let statusMessage: String = "Seems like Email or Password are wrong, try again"
...
extension TMDBResponse: LocalizedError {
    var errorDescription: String? {
        ...
        return statusMessage // alert appears with bold "OooNo, Login Failed" under which is text: "Invalid API key: You must be granted a valid key" as per Responses under code 401 from https://developers.themoviedb.org/3/authentication/validate-request-token
